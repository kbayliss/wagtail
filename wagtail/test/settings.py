...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "wagtail.contrib.settings.context_processors.site_settings",
                "wagtail.contrib.settings.context_processors.generic_settings",
            ],
    ...
    },
    {
        ...
        "OPTIONS": {
            "extensions": [
                ...
                "wagtail.contrib.settings.jinja2tags.generic_settings",
            ],
        },
    },
]
