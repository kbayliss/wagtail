...
from wagtail.test.testapp.models import ImportantPages, TestSiteSetting
    ...
    def test_for_site_returns_expected_settings(self):
        for site, expected_site_settings in (
            ...
            with self.subTest(site=site):
                self.assertEqual(TestSiteSetting.for_site(site), expected_site_settings)
    ...
    def test_for_request_returns_expected_settings(self):
        ...
        for request, expected_site_settings in (
            ...
            with self.subTest(request=request):
                self.assertEqual(
                    TestSiteSetting.for_request(request), expected_site_settings
                )
