...
class GlobalSettingMenuItem(MenuItem):
    ...
    def is_shown(self, request):
        return user_can_edit_global_setting_type(request.user, self.model)


class GlobalSettingAdminURLFinder(ModelAdminURLFinder):
...
class GlobalSettingRegistry(list):
    def register(self, model, **kwargs):
        ...
        def menu_hook():
            return GlobalSettingMenuItem(model, **kwargs)
        ...
        finder_class = type(
            "_GlobalSettingAdminURLFinder",
            (GlobalSettingAdminURLFinder,),
...
registry = GlobalSettingRegistry()
register_global_setting = registry.register_decorator
